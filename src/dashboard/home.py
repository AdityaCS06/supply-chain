...
try:
    ...
    with tab1:
        ...
        st.plotly_chart(px.line(daily, x="date", y="sales"), width='stretch')
    ...
    with tab2:
        ...
        if not data.empty:
            st.plotly_chart(px.line(data, x="date", y="sales"), width='stretch')
    ...
    with tab3:
        ...
        st.plotly_chart(px.pie(risk_df, names="risk_level"), width='stretch')
